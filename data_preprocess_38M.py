...
def partitioning(f_name):
	...
	test_38M_4 = DATA_PATH + head + "_38M_4.csv"
	test_38M_5 = DATA_PATH + head + "_38M_5.csv"
	'''
	...
	with open(f_name) as f:
		...
		f_38M_4 = open(test_38M_4, "wb")
		f_38M_5 = open(test_38M_5, "wb")
		...
		w_38M_4 = csv.writer(f_38M_4)
		w_38M_5 = csv.writer(f_38M_5)
		...
		for idx, row in enumerate(reader):
			...
			if count_i < len(idx_38M):
				if count_i < len(idx_38M)/5:
					w_38M_1.writerow(row)
				elif len(idx_38M)/5<= count_i < len(idx_38M)*2/5:
					w_38M_2.writerow(row)
				elif len(idx_38M)*2/5<= count_i < len(idx_38M)*3/5:
					w_38M_3.writerow(row)
				elif len(idx_38M)*3/5<= count_i < len(idx_38M)*4/5:
					w_38M_4.writerow(row)
				else:
					w_38M_5.writerow(row)
			else:
				break
			count_i+=1
